...
int leds[8] = {22, 23, 24, 25, 26, 27, 28, 29};
...
void setup() {
	...
	attachInterrupt(digitalPinToInterrupt(2), velocidadMenos, RISING); // INTERRUPCION DE SEÑAL
	attachInterrupt(digitalPinToInterrupt(3), velocidadMas, RISING); // INTERRUPCION DE SEÑAL
...
// INT pin 2, disminuye la velocidad
void velocidadMenos()
{
...
// INT pin 3, aumenta la velocidad
void velocidadMas()
{
